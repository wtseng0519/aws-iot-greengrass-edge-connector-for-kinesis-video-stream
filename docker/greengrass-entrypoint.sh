...
if [ ${EDGE_CONNECTOR_RESOURCE_PROVISION} = "true" ]; then
  # Provision sitewise resources and permissions
  python3 resourceManager.py
  echo "Provision sitewise resources and permissions ..."
  
  # Create a single greengrass v2 deployment
  python3 deployment.py 
  echo "Init greengrass deployment..."
fi
